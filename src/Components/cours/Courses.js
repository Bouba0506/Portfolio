...
const Courses = () => {
  return (
    ...
    <div className='my-20 w-full lg:flex  justify-between lg:space-y-0 space-y-8'>
      ...
      <div className='flex flex-col lg:w-[40%] w-full '>
        ...
        <div className='flex items-center gap-6'>
          <CustomeBtn title="Sign Up" stylebtn="w-36" />
      ...
      <div className='flex gap-3 lg:w-1/2 items-center'>
        ...
        <img src={pexel} alt='entrepe' className='rounded-3xl shadow-2xl'/>
        </div>
        <div className='flex flex-col gap-2 p-3 items-center w-1/2 '>
        {/* div 1 */}
          ...
          {/* div 2 */}
          <div className='hidden md:flex w-full h-1/2 flex-col rounded-3xl shadow-2xl '>
    ...
    {/* --------------cards------------------------- */}
    <div className='w-full py-4 px-2 bg-slate-300 rounded-xl lg:flex  justify-between items-center'>
      {/* ---------paragraphe----------------- */}
      ...
      {/* --------------------Abonner------------------ */}
      <div className='flex gap-8 justify-center lg:w-1/2 lg:items-center py-4 px-2 bg-slate-50 rounded-2xl'>
